...
import { Search, Filter, MoreHorizontal, MapPin, Package, Download, Eye, FileUp } from "lucide-react";
...
import { UploadLRDialog } from "@/components/upload-lr-dialog";
                  ...
                  <TableCell className="text-right">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem onClick={() => { setSelectedAwb(shipment.id); setUploadDialogOpen(true); }}>
                          <FileUp className="mr-2 h-4 w-4 text-[#f37a2a]" /> Upload LR/Docket
                        </DropdownMenuItem>
