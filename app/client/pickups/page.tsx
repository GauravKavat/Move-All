...
const PICKUP_ROWS: PickupRow[] = [
  {
    ...
    orderId: 'ORD-88301',
    deliveryAddress: 'Sector 18, Gurugram',
    weight: '142.5 kg',
    vehicle: 'TRK-11A',
    driver: 'Satish Kumar',
    estTime: '17 May, 16:45',
    status: 'Scheduled',
  },
  {
    pickupId: 'PCK-2102',
    ...
    orderId: 'ORD-88304',
    deliveryAddress: 'Ring Road, Indore',
    weight: '45 kg',
    vehicle: 'VAN-02B',
    driver: 'Amit Rawat',
    estTime: '17 May, 17:20',
    status: 'Scheduled',
  },
  {
    pickupId: 'PCK-2099',
    ...
    orderId: 'ORD-88305',
    deliveryAddress: 'Anna Salai, Chennai',
    weight: '28 kg',
    vehicle: 'MNV-14C',
    driver: 'Hina George',
    estTime: '17 May, 13:10',
    status: 'Completed',
  },
];
    ...
    <div className="space-y-5">
      <section className="grid grid-cols-1 gap-3 md:grid-cols-3">
        ...
        <article className="rounded-2xl border border-[#e8e5d7] bg-white p-5">
          ...
          <p className="mt-2 text-3xl font-bold text-black">118</p>
        ...
        <article className="rounded-2xl border border-[#e8e5d7] bg-white p-5">
          ...
          <p className="mt-2 text-3xl font-bold text-black">130</p>
          <span className="mt-1 inline-flex rounded-full bg-emerald-50 px-2 py-1 text-xs font-semibold text-emerald-700">Success Rate 96.1%</span>
        </article>
      </section>
