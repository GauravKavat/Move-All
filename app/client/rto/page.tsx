...
const RTO_ROWS = [
  { rtoId: 'RTO-1001', customer: 'Ananya Sharma', reason: 'Customer Refused Delivery', returnDate: '16 May 2026', status: 'In Transit' as RtoStatus },
  { rtoId: 'RTO-1002', customer: 'Nitin Traders', reason: 'Item Damaged', returnDate: '15 May 2026', status: 'Received' as RtoStatus },
  { rtoId: 'RTO-1003', customer: 'Mila Retail', reason: 'Address Mismatch', returnDate: '12 May 2026', status: 'Refunded' as RtoStatus },
];
