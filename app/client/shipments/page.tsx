...
const SHIPMENTS: ShipmentRow[] = [
  { awb: 'AWB-774920192', customerName: 'Rajesh Meena', courier: 'Bluedart', status: 'In Transit', eta: '19 May 2026', cost: 'Rs 450.00' },
  { awb: 'AWB-102948211', customerName: 'Ananya Sharma', courier: 'FedEx', status: 'RTO', eta: '18 May 2026', cost: 'Rs 180.00' },
  { awb: 'AWB-884102300', customerName: 'Acme Distribution Corp', courier: 'DHL', status: 'Out for Delivery', eta: '17 May 2026', cost: 'Rs 720.00' },
  { awb: 'AWB-651142921', customerName: 'Mila Retail', courier: 'DTDC', status: 'Delivered', eta: '17 May 2026', cost: 'Rs 390.00' },
];
